...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/10 12:10:04 by ffrimpon          #+#    #+#             */
/*   Updated: 2016/02/10 12:49:41 by ffrimpon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../fdf.h"

void	rgb(t_map *map, int r, int g, int b)
{
	map->color_r = r;
	map->color_g = g;
	map->color_b = b;
...
void	color_s(t_data *data)
{
	...
	while (1)
	{
		...
		map->z >= 10 && map->z < 17 ? rgb(map, 38, 115, 38) : 0;
		...
		map->z >= 35 && map->z < 49 ? rgb(map, 173, 116, 57) : 0;
